...
namespace Reestr.Blazor.Component.IdentityComponent
{
    public partial class LoginComponent : ComponentBase
    {
        ...
        [Inject]
        protected ReestrSecurityService ReestrSecurity { get; set; }
        ...
        {
            var dialogResult = await DialogService.OpenAsync<Pages.InfoUser.AddInfoUser>("Реєстрація користувача", null);
